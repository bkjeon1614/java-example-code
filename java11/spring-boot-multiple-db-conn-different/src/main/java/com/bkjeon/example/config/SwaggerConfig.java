...
public class SwaggerConfig {
    ...
    public Docket adminApiV2() {
        return new Docket(DocumentationType.SWAGGER_2)
            .groupName("v2")
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.bkjeon.example.services.api.v2"))
            .paths(PathSelectors.any())
            .build()
            .apiInfo(apiInfo("Example APIs V2(latest)", "Example APIs..", "v2"));
    }
    ...
    public Docket adminApiV1() {
        return new Docket(DocumentationType.SWAGGER_2)
            .groupName("v1 (latest)")
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.bkjeon.example.services.api.v1"))
            .paths(PathSelectors.any())
            .build()
            .apiInfo(apiInfo("Example APIs V1", "Example APIs..", "v1 (latest)"));
    }
